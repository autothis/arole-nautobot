...
# Branding of the Nautobot Portal
BRANDING_FILEPATHS = {
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "v8b0_x=$*xk#(8fk2sn4ska$l=3#i8ohm5guu%yf@dtxh3rub%")
...
#PLUGINS = ["nautobot_device_onboarding","nautobot-golden-config","nautobot_plugin_nornir"]
PLUGINS = ["nautobot_device_onboarding","nautobot-golden-config","nautobot_netbox_importer","nautobot_ssot","nautobot_ssot_vsphere"]
...
## logging LDAP to file
if LOG_LDAP_TO_CONSOLE:
    LOGGING['handlers']['nautobot_auth_log'] = {
        'level': 'DEBUG',
        'class': 'rq.utils.ColorizingStreamHandler',
        'formatter': 'normal',
    }
...
# this one breaks :(
# FileNotFoundError: [Errno 2] No such file or directory: '/opt/nautobot/logs/django-ldap-debug.log'
# does /opt/nautobot/logs/ exist?
# should we create a blank file first?
# elif LOG_LDAP_TO_FILE:
#    LOGGING['handlers']['nautobot_auth_log'] = {
#        'level': 'DEBUG',
